...
description: Cerca de 120 regras verificaveis de interface web (interacoes, formularios, feedback, animacao, layout, conteudo, performance, design responsivo e acessibilidade), do repo oficial vercel-labs/web-interface-guidelines. Usar ao escrever ou rever qualquer UI web, e como checklist antes de dar uma pagina por terminada. Complementa `craft` (nivel pixel) e `ux-heuristics-review` (nivel fluxo).
---

Fonte: https://github.com/vercel-labs/web-interface-guidelines (instalado 2026-07-28).
Num painel ou app: correr por rota antes de fechar cada fase de redesign.
